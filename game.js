...
const progressbarmeter = document.getElementById('progressbarmeter');
...
getNewQuestion = () => {
    ...
    progressbarmeter.style.width = `${(questionCounter / MAX_QUESTIONS) * 100}%`;
    const questionIndex = Math.floor((Math.random() * 10) % availableQuestion.length);
