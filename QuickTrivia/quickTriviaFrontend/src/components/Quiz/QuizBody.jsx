...
function QuizBody() {
    ...
    const { isLogin, userEmail } = useContext(UserContext);
    const { questions, quizID, categoryName, difficulty, amount } = useContext(QuizContext);
    ...
    const handleSubmit = async () => {
        ...
        if (isLogin) {
            ...
            await axios.post('user/auth/quizsave', { ...usersQuizData })
            setHideResult(false)
        } else {
            setHideResult(false)
        }
